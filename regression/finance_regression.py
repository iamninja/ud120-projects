...
print("Testing on train data gives score:", reg.score(feature_train, target_train))
print("Testing on test data gives score:", reg.score(feature_test, target_test))
...
print("Use test data to train")
reg.fit(feature_test, target_test)
plt.plot(feature_train, reg.predict(feature_train), color="y")
print("The slope of the new line \(yellow\) is", reg.coef_)
